...
func (s *Server) Routes() http.Handler {
	...
	mux.Handle("POST /settings/activity-types", protect(s.handleSelectedActivityTypesSave))
	...
	mux.HandleFunc("POST /internal/admin/users/{id}/debug-upload", s.handleAdminUserDebugUpload)
	mux.HandleFunc("GET /internal/admin/users/{id}/garmin/activities-raw", s.handleAdminGarminActivitiesRaw)
	mux.HandleFunc("POST /internal/admin/users/{id}/efb/revalidate", s.handleAdminUserEFBRevalidate)
